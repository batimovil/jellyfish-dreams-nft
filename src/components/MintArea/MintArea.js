...
const MintArea = () => {
  return (
      <>
        <Marquee direction={"left"} loop={0} speed={40} gradient={false}>
  ...
  {/* <WalletClient /> */}
        ...
        <section className={styles.startMint} >
          ...
          <div className={styles.mintForm}>
            ...
            <div> 
              <i></i> 
              <div> <span>price per jellyfish</span> <p>0.01 ETH</p> </div>
            </div>
            ...
            <div className={styles.okMint} >
              <div className={styles.totalCounter}><p>Total</p>
              <span>0.01 ETH</span></div>
